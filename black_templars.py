...
from math_hammer import Torrent, SustainedHits_1, LethalHits, DevestatingWounds, PlusOneToWound, PlusOneToHit
from math_hammer import StrengthPlusOne, AP_PlusOne, CriticalHit_5up, TwinLinked, AttacksPlusOne, DamagePlusOne
from math_hammer import RerollHits, RerollWounds, Reroll_D6_Damage, RerollWoundsOne
